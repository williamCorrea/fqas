...
vv2.id=v2.vector
and
abs(v1."%voix/exp2"-vv2."%voix/exp2")<=4
and 
abs(v1."%voix/exp3"-vv2."%voix/exp3")<=4
and
abs(v1."%voix/exp4"-vv2."%voix/exp4")<=4
and
abs(v1."%voix/exp8"-vv2."%voix/exp8")<=4
and
abs(v1."%voix/exp9"-vv2."%voix/exp9")<=4
and
abs(v1."%voix/exp10"-vv2."%voix/exp10")<=4
union 
