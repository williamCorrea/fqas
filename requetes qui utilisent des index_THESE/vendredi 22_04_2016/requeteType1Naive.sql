...
and
(d."%voix/exp2" between tr.v2-0.8 and tr.v2+0.8) and
(d."%voix/exp3" between tr.v3-0.8 and tr.v3+0.8) and
(d."%voix/exp4" between tr.v4-0.8 and tr.v4+0.8) and
(d."%voix/exp8" between tr.v8-0.8 and tr.v8+0.8) and
(d."%voix/exp9" between tr.v9-0.8 and tr.v9+0.8) and
(d."%voix/exp10" between tr.v10-0.8 and tr.v10+0.8)